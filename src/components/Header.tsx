...
interface HeaderProps {
  ...
  onOpenAdmin?: () => void;
  onOpenBrand?: () => void;
  activePortal?: 'home' | 'admin' | 'brand';
  brandTitle?: string;
}

const Header: FC<HeaderProps> = ({ onGoHome, onOpenAdmin, onOpenBrand, activePortal = 'home', brandTitle }) => {
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        {activePortal === 'brand' ? (
          <div className="flex w-full items-center justify-between gap-4">
            <div>
              <p className="text-sm text-gray-500">{brandTitle}</p>
            </div>
